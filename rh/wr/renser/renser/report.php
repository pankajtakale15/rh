...
<script>
    function setInputType()
    {
        ...
        if(val == "expiry")
        {
            ...
            document.getElementById("expirySearch").style.display = "block";
        }
...
<div class="container w3-collapse">
  ...
  <ul class="nav nav-tabs" style="margin-right:40px; margin-left:-10px;">
    <li  class="active"><a data-toggle="tab" href="#graph" ng-click="initGraph();getRenewalServices('all',1,15,100);" style="color:#000000;"><b>Records</b></a></li>
    <li><a data-toggle="tab" href="#recordByCat" ng-click="initGraph();colapseReportDiv();" style="color:#000000;"><b>Records by category</b></a></li>
    <li><a data-toggle="tab" href="#recordWithNoUser" ng-click="initGraph();colapseReportDiv();getRenewalServicesNoUser();" style="color:#000000;"><b>Records of Removed Users</b></a></li>
   
    <!--<li><a data-toggle="tab" href="#searchRecord" ng-click="initGraph();" style="color:#000000;"><b>Search Record</b></a></li> -->
  </ul>
  <div class="tab-content" style="margin-right:40px; margin-left:-10px;">
						...
						<div class="col-md-12 text-left"  frame="box">
								...
								<thead>
									<tr>
										<th class="btn-duereport"
											...
											ng-click="getRenewalServices('all',1,15,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass15"
											ng-click="addActiveClassForReminder('15');hideAlerts('reportAlertMsg');">Due in 15 days</span></th>
										<th class="btn-duereport"
											ng-class="{'btn-duerportactive' : activeReportClass30}"
											ng-click="getRenewalServices('all',15,30,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass30"
											ng-click="addActiveClassForReminder('30');hideAlerts('reportAlertMsg');">Due in 30 days</span></th>
										<th class="btn-duereport"
											ng-class="{'btn-duerportactive' : activeReportClass60}"
											ng-click="getRenewalServices('all',30,60,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass60"
											ng-click="addActiveClassForReminder('60');hideAlerts('reportAlertMsg');">Due in 60 days</span></th>
										<th class="btn-duereport"
											ng-class="{'btn-duerportactive' : activeReportClass90}"
											ng-click="getRenewalServices('all',60,100000,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass90"
											ng-click="addActiveClassForReminder('90');hideAlerts('reportAlertMsg');"> > 60 days</span></th>
		                                <th class="btn-duereport"
											ng-class="{'btn-duerportactive' : activeReportClass0}"
											ng-click="getRenewalServices('all',-999,0,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass0"
											ng-click="addActiveClassForReminder('0');hideAlerts('reportAlertMsg');">Expired</span></th>
										<th class="btn-duereport"
											ng-class="{'btn-duerportactive' : activeReportClass00}"
											ng-click="getRenewalServices('closed',-9999,9999,100);hideAlerts('reportAlertMsg');"><span
											ng-model="activeReportClass00"
											ng-click="addActiveClassForReminder('00');hideAlerts('reportAlertMsg');">Closed</span></th>
									</tr>
								</thead>
							</table>
							...
							<table id="renserGridId2" class="table table-bordered"  style="width: 250%; max-width: 250%;">
								...
								<span class="ng-hide">{{renewalService.remainingDays < 1 ? 'Deactive' : 'Active'}}</span>
									...
									<td class="text-center"><a class="label label-danger" href="" ng-click="deleteReport(renewalService,renewalService.id,renewalService.category,renewalService.subcategory);getUserInfo();getDashboardInfo();getRenewalServicesCount();"><span class="glyphicon glyphicon-remove"></span> Delete
									</a>
                                    ...
                                    <a style="cursor:pointer;  color: green; " title="Save" ng-show="renewalServiceDetails.showEdit" ng-click="renewalServiceDetails.showEdit = !renewalServiceDetails.showEdit;updateRenewalService(renewalService,renewalService.id);getDashboardInfo();" class="btn btn-xs btn-primary glyphicon glyphicon-ok-circle"></a>
									...
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.entity}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.entity" id="entity_{{renewalService.id}}"></td>
									...
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.escalationEmail}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.escalationEmail" id="escalationEmail_{{renewalService.id}}"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.escalationStart}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.escalationStart" id="escalationStart_{{renewalService.id}}"></td>
									<td class="text-center"><span ng-bind="renewalService.remainingDays"></span></td>
									<td>
										<a ng-show="!renewalServiceDetails.showEdit" ng-hide="renewalService.filepath==''" class="glyphicon glyphicon-download-alt btn btn-default"
									 	...
									 	<input ng-show="renewalServiceDetails.showEdit" type="file" ng-file-model="files" ng-click="setCurrentIndex(1)"  onchange="angular.element(this).scope().setFile(this)" multiple   />
								    </td>
    ...
    <div id="recordWithNoUser" class="tab-pane fade">
	     <div class="panel panel-default" style="border-top: none;border-color: #eee;">
			
			<div class="panel-body">
				<div class="row renewalMarginBottom" style="margin-top: 20px">
					<div class="col-md-12 "  frame="box" style="background-color: white;border-right: 1px solid #e3e3e3;">
						<div id="reportAlertMsgNoUser" class="ng-hide"></div>
						<div class="col-md-12 text-left"  frame="box">
							<a  href="" ng-click="exportToExcel('#renserGridIdNoUser')"> <i class="glyphicon glyphicon-download-alt" style="color:black;font-size:15px;"></i>&nbsp;Excel</a> &nbsp;&nbsp; 
							<a  href="" ng-click="printData('#renserGridIdNoUser')"> <i class="glyphicon glyphicon-print" style="color:black;font-size:15px;"></i>&nbsp;Print</a> 
						</div>
						
							<table id="renserGridIdNoUser" class="table table-bordered ">
								<thead>
									<tr>
									</tr>
								</thead>
							...
							<div class="table-responsive">
							<table id="renserGridIdNoUser" class="table table-bordered"  style="width: 250%; max-width: 250%;">
								<thead>
									<tr class="header">
									<th>Status</th>
									<th>Delete</th>
								...
								<tr data-ng-repeat="renewalService in renewalServicesListNoUser" id="reportTableRow_{{renewalService.id}}">
								<td class="text-center"><span class="glyphicon glyphicon-record" title="{{renewalService.remainingDays < 1 ? 'Deactive' : 'Active'}}" ng-class="renewalService.remainingDays < 1 ? 'serviceDeactive' : 'serviceActive'"></span>
								<span class="ng-hide">{{renewalService.remainingDays < 1 ? 'Deactive' : 'Active'}}</span>
								</td>
									<td class="text-center"><a class="label label-danger" href="" ng-click="deleteReport(renewalService,renewalService.id,renewalService.category,renewalService.subcategory);getUserInfo();getDashboardInfo();getRenewalServicesCount();"><span class="glyphicon glyphicon-remove"></span> Delete
                                    ...
                                    <td><span ng-bind="renewalService.currentStatus" id="currentStatusNoUser_{{renewalService.id}}"></span></td>
                                    <td><select ng-model="renewalService.updateStatus" id="updateProcessStatusNoUser_{{renewalService.id}}" ng-change="updateProcessStatus(renewalService.id)" class="form-control">
											<option value="OPEN" selected="selected">OPEN</option>
											<option value="IN PROGRESS">IN PROGRESS</option>
											<option value="CLOSE">CLOSE</option>
										</select>
									</td>
									<td><span ng-bind="renewalService.category" id="catNoUser_{{renewalService.id}}"></span></td>
									<td><span ng-bind="renewalService.subcategory" id="subcatNoUser_{{renewalService.id}}"></span></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.entity}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.entity" id="entity_{{renewalService.id}}"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.description}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.description" id="descriptionNoUser_{{renewalService.id}}"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.model}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.model" id="modelNoUser_{{renewalService.id}}"></td>
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.amount}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.amount" id="amountNoUser_{{renewalService.id}}" onkeypress="return isNumberKey(event)"></td>
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.gst}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.gst" id="gstNoUser_{{renewalService.id}}"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.supplierName}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.supplierName" id="supplierNameNoUser_{{renewalService.id}}"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.supplierEmail}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.supplierEmail" id="supplierEmailNoUser_{{renewalService.id}}"></td>
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.supplierContact}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.supplierContact" id="supplierContactNoUser_{{renewalService.id}}" onkeypress="return isNumberKey(event)"></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.location}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.location" id="locationNoUser_{{renewalService.id}}"></td>
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.contractNo}}</span>
									<input ng-show="renewalServiceDetails.showEdit" type="text" class="form-control" ng-model="renewalService.contractNo" id="contractNoNoUser_{{renewalService.id}}"></td>
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.purchaseDate.slice(0, 10)}}</span>
									    <div class="input-group" ng-show="renewalServiceDetails.showEdit">
										    <input type="text" id="purchaseDateNoUser_{{renewalService.id}}" ng-show="renewalServiceDetails.showEdit"
												class="form-control"
											    ng-model="renewalService.purchaseDate" datepicker></input><span ng-show="renewalServiceDetails.showEdit"
												class="input-group-addon" id="basic-addon1"><span ng-show="renewalServiceDetails.showEdit"
												class="glyphicon glyphicon-calendar"></span>
									...
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.expiryDate.slice(0, 10)}}</span>
									    <div class="input-group" ng-show="renewalServiceDetails.showEdit">
										    <input type="text" id="expiryDateNoUser_{{renewalService.id}}" ng-show="renewalServiceDetails.showEdit"
												class="form-control"
											    ng-model="renewalService.expiryDate" ng-change="calDiffUpdateRecord(renewalService.expiryDate, renewalService.id);" datepicker></input><span ng-show="renewalServiceDetails.showEdit"
												class="input-group-addon" id="basic-addon1"><span ng-show="renewalServiceDetails.showEdit"
												class="glyphicon glyphicon-calendar"></span>
									...
									<!-- <td><span ng-bind="renewalService.comment"></span></td>-->
									<td class="text-center"><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.reminderBefore}}</span>
									<select ng-show="renewalServiceDetails.showEdit" ng-model="renewalService.reminderBefore" class="form-control" id="reminderBeforeNoUser_{{renewalService.id}}">
											<option value="">Select Reminder</option>
											<option ng-repeat="reminderObj in reminderList" value="{{reminderObj.id}}" ng-hide="dayDifference < {{reminderObj.id}}">{{reminderObj.id}}</option>
									</select></td>
									<td><span ng-show="!renewalServiceDetails.showEdit">{{renewalService.escalationEmail}}</span>
				...
				<a  href="" ng-click="exportToExcel('#renserGridId3')"> <i class="glyphicon glyphicon-download-alt" style="color:black;font-size:15px;"></i>&nbsp;Excel</a> &nbsp;&nbsp;
					...
					<table id="renserGridId3" class="table table-bordered " style="width: 250%; max-width: 250%;" >
						...
						<td class="text-center"><span class="glyphicon glyphicon-record" title="{{renewalService.remainingDays < 1 ? 'Deactive' : 'Active'}}" ng-class="renewalService.remainingDays < 1 ? 'serviceDeactive' : 'serviceActive'"></span></td>
							...
							<td><span ng-bind="renewalService.entity"></span></td>
							...
							<td><span ng-bind="renewalService.escalationEmail"></span></td>
							<td class="text-center"><span ng-bind="renewalService.escalationStart"></span></td>
							<td class="text-center"><span ng-bind="renewalService.remainingDays"></span></td>
							<td><a ng-hide="renewalService.filepath==''" class="glyphicon glyphicon-download-alt btn btn-default"
									 style="font:16px;color: white;" title="{{renewalService.filepath}}" 
									 href="../controller/downloadFile1.php?name={{renewalService.filepath}}&filepath=uploads/<?php echo $userObject2->imgDir;?>"> </a>
				...
				<div class="panel-body">
					...
					<a  href="" ng-click="printData('#renserGridId4')"> <i class="glyphicon glyphicon-print" style="color:black;font-size:15px;"></i>&nbsp; Print</a> 
						...
						<table id="renserGridId4" class="table table-bordered" style="width: 250%; max-width: 250%;">
							...
							<tr data-ng-repeat="renewalService in renewalServicesList">
							   <td class="text-center"><span class="glyphicon glyphicon-record" title="{{renewalService.remainingDays < 1 ? 'Deactive' : 'Active'}}" ng-class="renewalService.remainingDays < 1 ? 'serviceDeactive' : 'serviceActive'"></span></td>
								<td class="text-center"><a class="label label-danger" href="" ng-click="deleteReport(renewalService,renewalService.id,renewalService.category,renewalService.subcategory); getRenewalServicesCount();"><span class="glyphicon glyphicon-remove"></span> Delete
									</a>
									<span class="ng-hide">Not deleted</span>
									</td>
								<td><span ng-bind="renewalService.category"></span></td>
